...
public class pucca_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/images/icon pucca.png"))); // NOI18N

        btnentrar.setActionCommand("ENTRAR");
        btnentrar.setBackground(new java.awt.Color(184, 20, 20));
        ...
        txtItName.setText("it name INESQUECÍVEL!");
